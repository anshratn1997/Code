...
//.............staic class end.
  ...
  long find(int ind, Queue<Integer> Q){
     if(ind == str.length()){
      //  pt(ind,Q);
       return 1;
     }
     int a = str.charAt(ind) - 48;
     if(Q.size() >= 2){
        Q.clear();
        Q.add(a);
        // pt(ind,Q);
        return find(ind+1,Q);
          ...
          if(sum > 26){
            ...
            Queue<Integer> n_ = new LinkedList<>();
            n_.add(a);
            // pt(ind,Q);
            return find(ind+1,Q) + find(ind+1,n_);
          }
     }
  }
